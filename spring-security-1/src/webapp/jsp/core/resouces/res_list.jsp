...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <div id="sys_resman_tools" style="text-align: right;" data-options="closed:true,width:600,height:400,modal:true,,iconCls:'icon-role'">
            <label>资源名称：</label>
            ...
            <security:authorize access="hasRole('AUTH_RESOUCES_ADD')">
                <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true"
                   onclick="addRes();">添加</a>
            </security:authorize>
            <security:authorize access="hasRole('AUTH_RESOUCES_DELETE')">
